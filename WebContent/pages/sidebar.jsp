...
<!-- 					<li  data-pre="27" id="o27"><a href="addRopeMaking.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b>Rope Making</b></a></li> -->
	 	 ...
	 	 <li><a href="javascript:void(0);"><i
			...
			<li><a href="javascript:void(0);"><i
				...
				<li><a href="javascript:void(0);"><i
					class="sidebar-item-icon fa fa-th-large"></i> <span
					class="nav-label">9.&nbsp;Genration Demand Note</span> <i
					class="fa fa-angle-left arrow"></i></a>
				<ul class="nav-2-level ">
				...
				<li><a href="javascript:void(0);"><i
					class="sidebar-item-icon fa fa-th-large"></i> <span
					class="nav-label">10.&nbsp;Mill menu</span> <i
					class="fa fa-angle-left arrow"></i></a>
				<ul class="nav-2-level ">
                    ...
                    <li  data-pre="44" id="o44"><a href="viewMillReciept.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b>View of Mill Receipt</b></a></li>
                     <li  data-pre="44" id="o44"><a href="EntryGenerationCashagainstDispatch.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b> Generation of Cash against Dispatch Document </b></a></li>
				    <li  data-pre="44" id="o44"><a href="viewGenrationCashDocument.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b> View CashDispatch Document </b></a></li>
				<li  data-pre="44" id="o44"><a href="EntrySubmissionofQuote.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b> Entry Submission of Quote </b></a></li>
				<li  data-pre="44" id="o44"><a href="viewsubmissionOfQuoteModel.obj"><i class="sidebar-item-icon fa fa-th-large"></i><b> View Submission of Quote </b></a></li>
				
				</ul></li>
				<li><a href="javascript:void(0);"><i
					class="sidebar-item-icon fa fa-th-large"></i> <span
					class="nav-label">11.&nbsp;Claim Settlement’ Menu</span> <i
					class="fa fa-angle-left arrow"></i></a>
				<ul class="nav-2-level ">
				...
				<li><a href="javascript:void(0);"><i
					class="sidebar-item-icon fa fa-th-large"></i> <span
					class="nav-label">12.&nbsp;Commercial / Daily Sales / Free Sale</span> <i class="fa fa-angle-left arrow"></i></a>
				<ul class="nav-2-level">
