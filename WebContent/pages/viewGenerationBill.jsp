								...
								<tbody>
									...
									<%-- 	
										 <td>
											...
											<td>--%>
											   <!--  <td> 
											        <button class="btn btn-outline-success" onclick="generateAndDownloadPdf()">
											...
											<script>
											    function generateAndDownloadPdf() {
											        // Use AJAX to trigger the PDF generation on the server
											    ...
											    function generateAndDownloadPdf() {
											        ...
											        $.ajax({
											            ...
											            success: function(response) {
											                // Assuming the response contains the file path of the generated PDF
											                var filePath = response.filePath;
											
											                // Create a download link for the generated PDF
											                var link = document.createElement('a');
											                link.href = '/downloadPDF.obj?filePath=' + encodeURIComponent(filePath);
											                link.target = '_blank';
										...
										<td>
										    ...
										    <script>
										        function downloadPDF(filePath) {
										            ...
										            var downloadURL = '<%= request.getContextPath() %>downloadPDF.obj?filePath=' + filePath;
