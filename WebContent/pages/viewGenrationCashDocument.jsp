	...
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="page-heading">
				<h1 class="page-title">View Generation of Cash against Dispatch Document </h1>

			</div>

			<%
			List<CashDocumentModel> cashDocumentModellist = (List<CashDocumentModel>)request.getAttribute("cashDocumentModel");
						...
						<div class="scrollmenu">
							<table
								...
								<tbody>
									<%
									int i = 1;
									for (CashDocumentModel  cashDocumentModel : cashDocumentModellist) {
									...
									<tr>
										...
										<td><%= cashDocumentModel.getCAD_Date() %></td>
