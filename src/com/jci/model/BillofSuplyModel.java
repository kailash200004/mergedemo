...
@Entity
@Table(name = "jcibos_generation", schema = "dbo")
public class BillofSuplyModel {
		...
		public int getBos_id() {
			return Bos_id;
		}



		public void setBos_id(int bos_id) {
			Bos_id = bos_id;
		}
		...
		public BillofSuplyModel(int bos_id, String challan_No, String challan_date, String shipment_details,
				String shipment_value, String sGST_amt, String cGST_amt, String iGST_amt, String tCS_amt,
				String tDS_amt, String invoice_value, String bill_of_supply_no, String bOS_date, String supplier_name,
				...
				String bos_file_path, String ro_id, Timestamp creation_date) {
			super();
			Bos_id = bos_id;
			Challan_No = challan_No;
			Challan_date = challan_date;
		...
		public String toString() {
			return "BillofSuplyModel [Bos_id=" + Bos_id + ", Challan_No=" + Challan_No + ", Challan_date="
					...
					+ Bill_of_supply_no + ", BOS_date=" + BOS_date + ", Supplier_name=" + Supplier_name
					+ ", Supplier_gSTN=" + Supplier_gSTN + ", Supplier_address=" + Supplier_address
					+ ", Recipient_name=" + Recipient_name + ", Recipient_gSTN=" + Recipient_gSTN
					+ ", Recipient_address=" + Recipient_address + ", Consignee_name=" + Consignee_name
					+ ", Consignee_gSTN=" + Consignee_gSTN + ", Consignee_address=" + Consignee_address
					+ ", Bos_file_path=" + Bos_file_path + ", Ro_id=" + Ro_id + ", Creation_date=" + Creation_date
					+ "]";
		}
